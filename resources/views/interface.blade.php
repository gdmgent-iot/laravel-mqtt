...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-center">Working with mqtt & datsabase</h1>
                    ...
                    <form action="" method="post">
                        ...
                        <button type="submit" class="btn btn-primary">Get beestje</button>
                    </form>

                    <div class="mt-6">
                        <h2>Animal</h2>
                        <p class="alert alert-success" id="message"></p>
                        <code class="form-control" name="animal" id="animal" cols="30" rows="10"></code>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        const hostIP = "192.168.0.66";
        const port = 9001;
        var client = mqtt.connect('ws://' + hostIP + ':' + port);
        
        client.on('connect', function () {
            client.subscribe('animal/jump', function (err) {
                if (!err) {
